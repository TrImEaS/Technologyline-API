...
async function refreshDB() {
  ...
  try {
    ...
    var updateProductQueries = [];
    var insertProductQueries = [];
    var updateProductImagesQueries = [];
    var excelProductIds = {};

    for (var i = 0; i < productsExcel.length; i++) {
      var p = productsExcel[i];
      var sku = p.sku;
      if (!sku) continue;
    ...
    var hasErrors = false;
    var allQueries = updateProductQueries.concat(insertProductQueries).concat(updateProductImagesQueries);
